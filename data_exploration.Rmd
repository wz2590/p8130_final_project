...
```{r}
mult.fit_lasso_1 = lm(CRM_1000 ~ pop18 + pop65 + poverty + bagrad + totalinc + pop_den + pbeds + state, data = cdi)
summary(mult.fit_lasso_1)
```


```{r}
mult.fit_lasso = lm(sqrt_CRM_1000 ~ pop18 + poverty + bagrad + pcincome + pop_den + state, data = cdi_sqrt)
summary(mult.fit_lasso)
```
